...
export default function Home() {
  return (
    ...
    <div className='w-full'>
      <br></br>
      <div style={{ textAlign: 'left', border: '1px solid #ddd ', padding: '20px',  backgroundColor: '#F8F8FF'}}>
      <h1 style={{ fontSize: '36px', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' }}>關於我們</h1>
      <p>
      ...
      <br></br>
      <div style={{ textAlign: 'left', border: '1px solid #ddd', padding: '20px', backgroundColor: '#F8F8FF' }}>
      <h1 style={{ fontSize: '36px', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' }}>使用說明</h1>
      <div>
      ...
      <br></br>
      <div style={{ textAlign: 'left', border: '1px solid #ddd', padding: '20px',  backgroundColor: '#F8F8FF'}}>
      <h1 style={{ fontSize: '36px', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' }}>會員權益</h1>
      <div>
